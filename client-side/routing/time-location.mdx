...
The time setup screen is one of the most complex screens in the app (~450 lines). It manages:
...
- **Unchecked (One Week):** Sets ends.type to after with count calculated from days * slots
